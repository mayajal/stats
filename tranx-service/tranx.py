...
class NormalityTester:
    ...
    def apply_transformations(self, data):
        ...
        power_data = pt.fit_transform(data.reshape(-1, 1)).flatten()
        transformations['yeo_johnson'] = {'data': power_data, 'lambda': pt.lambdas_[0], 'normality_tests': self.test_normality(power_data), 'applicable': True}
